...
public class C03_WindowHandle {
    ...
    public void test01() throws InterruptedException {
        ...
        //iki sayfa açılacağı için iki sayfanın window handle değerlerini set ile alıp kaydederiz
        Set<String> ikiSayfaninWHDegerleriSeti= driver.getWindowHandles();

        String ikinciSayfaWHD="";

        //Set'i for each loop ile elden geçiririz.
        // WHD değerlerinden birinci sayfanın WHD'ine eşit olmayan ikinci sayfanınkidir deriz
        ...
        // artık elimizde iki sayfanında handle değeri var, istediğimiz sayfaya geçebiliriz
