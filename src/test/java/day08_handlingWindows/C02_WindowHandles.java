    ...
    public void test01() throws InterruptedException {
        ...
        /*
               ...
               4- bu sekilde 2.sayfanin WHD elde edildikten sonra
                  ...
                  3 window varsa, set ile onları da alırız. ör 1 ve 2'ye eşit olmayan diye bakarız
         */

        Set<String> tumWHDegerleriSeti= driver.getWindowHandles();
        //Set'i import etmeliyiz

        String ikinciSayfaWHD="";
        for (String eachWhd: tumWHDegerleriSeti
        ) {
            if (!eachWhd.equals(ilkSayfaHandleDegeri)){ //ilk sayfaya eşit olmayanı arıyoruz
